...
const HeroSection = () => {
  ...
  return (
    ...
    lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
        ...
        <h1 className=' text-5xl md:text-[70px] md:leading-18 font-semibold max-w-110'>Guardians <br/> of the Gallery</h1>
        ...
        <p>In a post-apocalyptic world where cities ride on wheels and<br/>
        ...
        transition rounded-full font-medium cursor-pointer' onClick={() => navigate('/movies')}>
            Explore Movies
