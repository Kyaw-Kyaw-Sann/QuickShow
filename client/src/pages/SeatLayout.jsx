...
const SeatLayout = () => {
  ...
  return show ? (
    <div className="flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-32 md:pt-52">
      {/* Available Timings */}
      <div className="w-60 bg-primary/10 border border-primary/20 rounded-lg py-10 h-max md:sticky md:top-[120px]">
      ...
      <div className='relative flex-1 flex flex-col items-center max-md:mt-16'>
        ...
        <BlurCircle bottom='0' right='0'/>
         ...
         <div className='flex flex-col items-center mt-10 text-xs text-gray-300'>
          ...
          gap-1 mt-20 px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-full
